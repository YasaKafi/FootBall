...
class _TableScreenState extends State<TableScreen> {
  ...
  getTable() async {
    http.Response response = await http.get(
      Uri.parse('http://api.football-data.org/v2/competitions/${widget.code}/standings',
          ),
      ...
      child: Center(
        child: CircularProgressIndicator(
          valueColor: AlwaysStoppedAnimation<Color>(
            Color.fromRGBO(234, 250, 234, 1.0),
          ),
        ),
      ),
    )
      ...
      body: Container(
        decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: [
                const Color.fromRGBO(214, 245, 214,1),
                const Color.fromRGBO(234, 250, 234, 1.0),
              ],
